...
function loadWidget(config) {
	...
	let userAction = false,
		userActionTimer,
		messageTimer,
		messageArray = ["你今天有没有想念人家呀！？~~", "大坏蛋！你都多久没理人家了呀，嘤嘤嘤～","人工智能模式启动中...!!!!启动失败!!!...已切换人工智障模式","如果我要天上的月亮，你会摘下来给我么！？~~", "你觉得我~可爱吗~~？~~~~~好，我知道了~", "算了，你专心阅读文章吧！我不打扰你了!"];
	...
	(function registerEventListener() {
		...
		document.querySelector("#waifu-tool .fa-info-circle").addEventListener("click", () => {
			open("https://github.com/OldHuang-C");
		});
